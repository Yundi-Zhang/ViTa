...
import torch
from models.ResNet50Classification import ResNet50Classification
...
TABULAR_IMAGING_MODULE_LUT = {"pretraining": [MultimodalSimCLR],
                              "reconstruction": [SimCLRTabRecon, ResNet50Classification],}
...
def initialize_imaging_tabular_model(params, paths, data_module):
    ...
    elif params.module.task_idx == 2: module_key = "cl_reconstruction"
