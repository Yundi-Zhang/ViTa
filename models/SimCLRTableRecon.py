...
from utils.losses import BinaryReconCriterion, CategoricalReconCriterion, NumericalReconCriterion
...
class SimCLRTabRecon(pl.LightningModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        elif self.head_type in ["single_categorical", "multi_categorical"]:
